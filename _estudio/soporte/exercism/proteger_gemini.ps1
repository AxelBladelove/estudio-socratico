...
$trackedConfigPath = Join-Path $resolvedRoot "_estudio\soporte\exercism\config.json"
$localConfigPath = Join-Path $resolvedRoot "_estudio\soporte\exercism\config.local.json"
...
Write-Host "Gemini config protegida en _estudio/soporte/exercism/config.json"
