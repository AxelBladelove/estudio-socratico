...
try {
  ...
  execSync('bun run alejandro:icons', { stdio: 'inherit' });

  console.log("3. Generating Report...");
  execSync('bun run alejandro:semantic:report', { stdio: 'inherit' });

  console.log("4. Applying Results to Local Files...");
  execSync('bun run alejandro:semantic:apply', { stdio: 'inherit' });
