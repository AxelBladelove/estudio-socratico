<!--
PLANTILLA BASE DE errores.md

La IA debe agregar nuevas secciones ARRIBA de este comentario, o incrementar la
Frecuencia de una seccion existente sin borrar entradas previas.
-->
...
- Si es un patrón nuevo: agrega una nueva sección al final del archivo, antes de este comentario.
