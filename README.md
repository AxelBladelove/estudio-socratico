...
2. Descarga el instalador ejecutable de la versión 2.0 (ej. `Estudio-Socratico-Setup-v2.0.11-x64.exe`).
...
Abre `Estudio-Socratico-Setup-v2.0.11-x64.exe` y elige **Reparar**.
